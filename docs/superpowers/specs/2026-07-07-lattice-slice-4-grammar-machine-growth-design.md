...
| Guard candidates in the solver loop; entailment classification; CTI-guided inference; guard-completeness / deadlock / reachability | An **inference slice** — brief written 2026-07-08: [`2026-07-08-lattice-inference-slice-brief.md`](2026-07-08-lattice-inference-slice-brief.md) | Guards on committed specs = the corpus §9.1 classifies (landed `b8fecf7`) |
...
| Method-guard ⊨ transition-guard entailment; solver encoding of methods | **Inference slice** (brief: [`2026-07-08-lattice-inference-slice-brief.md`](2026-07-08-lattice-inference-slice-brief.md)) | Real `performs` + method-`requires` usage from this slice |
