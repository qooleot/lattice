...
| Structure | [`context.md`](context.md), [`module.md`](module.md), [`enum.md`](enum.md), [`entity.md`](entity.md), [`value.md`](value.md), [`aggregate.md`](aggregate.md), [`field-types.md`](field-types.md), [`event.md`](event.md) |
