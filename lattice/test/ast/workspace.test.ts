...
const catalog: DomainModel = { context: 'Catalog', enums: [], values: [], events: [], aggregates: [], services: [],
  entities: [{ kind: 'entity', name: 'Plan',
    fields: [{ name: 'planId', type: { kind: 'prim', prim: 'Id' }, key: true }] }] };
const subs: DomainModel = { context: 'Subscriptions', enums: [], values: [], events: [], entities: [], services: [],
